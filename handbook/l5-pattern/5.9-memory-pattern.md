...
> - [S 级] Letta GitHub 仓库 — https://github.com/letta-ai/letta
> - [S 级] LangGraph 官方文档 (Checkpointer) — https://langchain-ai.github.io/langgraph/concepts/persistence/
> - [A 级] Lilian Weng, *LLM Powered Autonomous Agents* (2023) — https://lilianweng.github.io/posts/2023-06-23-agent/
> - 本地参考: L2.6 短期记忆 + L2.7 长期记忆 — `handbook/l2-context/2.6-short-term-memory.md`、`2.7-long-term-memory.md`
