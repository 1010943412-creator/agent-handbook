...
2. **关键机制（5 个要点）**
   ...
   - **三范式对比**（数据来源：各原论文实验结果综合，**定性估算**；具体数字依任务类型、文档规模、基线模型不同有显著差异，生产决策前应做自家业务的离线评测）：
...
> - [A 级] Eugene Yan, *Improving Recommendation Systems & Search in the Age of LLMs* — https://eugeneyan.com/writing/recsys-llm/ （LLM + 检索增强的工程实践与对比）
